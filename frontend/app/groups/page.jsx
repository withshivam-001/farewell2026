...
export default function GroupsPage() {
  ...
  const fetchData = useCallback(async (showRefreshing = false) => {
    ...
    try {
      ...
      setOpenGroup((prev) => {
        if (!prev) return null;
        return fetchedGroups.find((g) => g._id === prev._id) || prev;
      });
    } catch (err) {
              ...
              <div className="glass rounded-3xl overflow-hidden">
                ...
                >
                  ...
                  <div className="relative z-10 text-center">
                    <div
                      className="w-20 h-20 rounded-3xl flex items-center justify-center text-white text-4xl font-black mx-auto mb-3"
                      style={{
            ...
            {allImages.length === 0 ? (
              <div className="text-center py-20 glass rounded-2xl">
                ...
                <p className="text-white/40 mb-2">
                  Is group mein abhi koi photo nahi hai
                </p>
                <p className="text-white/25 text-sm mb-6">
                  Images add karo — admin approve karne ke baad yahan dikhenge
                </p>
                <button
                  onClick={() => setShowImageUpload(openGroup)}
              ...
              >
                {allImages.map((img, i) => (
                  <motion.div
                    ...
                    onClick={() =>
                      setPreviewImg({ images: allImages, index: i })
                    }
                  >
                  ...
                  <div className="relative aspect-square bg-gradient-to-br from-purple-900/30 to-pink-900/20 overflow-hidden">
                    {g.images?.length > 0 ? (
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        <div
                          className="w-16 h-16 rounded-2xl flex items-center justify-center text-white text-3xl font-black mb-2"
                          style={{
                            background:
            ...
            >
              ...
              <div className="glass rounded-xl p-4 mb-5 border border-yellow-500/20">
                ...
                <p className="text-white/50 text-xs leading-relaxed">
                  Request → Admin approve → Group bane → Tum images add karo →
                  Admin approve → Gallery mein dikhe
                </p>
              </div>
              <form onSubmit={handleGroupRequest} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="CS-A 2024, Friends Gang..."
                    maxLength={80}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    maxLength={400}
                    placeholder="Group ke baare mein..."
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={() => setShowRequestForm(false)}
                    className="flex-1 py-3 rounded-xl text-sm text-white/50 border border-white/10 hover:bg-white/5"
                  >
                    Cancel
                  </button>
                  <button
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-white/40 text-xs mt-0.5">
              Group: <span className="text-purple-300">{group.name}</span>
            </p>
          </div>
        ...
        <div className="glass rounded-xl p-4 mb-4 border border-purple-500/20">
          ...
          <p className="text-white/50 text-xs">
            Admin approve karne ke baad gallery mein dikhenge.
          </p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div
              className="border-2 border-dashed border-white/15 rounded-xl p-5 text-center cursor-pointer hover:border-purple-500/40 transition-colors"
            ...
            >
              {previews.length > 0 ? (
                ...
                <div>
                  ...
                  <p className="text-white/50 text-sm">Click karo</p>
                </div>
              )}
              <input
                id="grp-imgs-inp"
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 py-3 rounded-xl text-sm text-white/50 border border-white/10"
            >
              Cancel
            </button>
            <button
          ...
          {images.map((img, i) => (
            <button
              ...
              style={{
                ...
                border:
                  i === current ? "2px solid #7c3aed" : "2px solid transparent",
              }}
            >
              <img
                src={img.url}
